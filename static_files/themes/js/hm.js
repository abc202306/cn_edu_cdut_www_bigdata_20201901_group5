(function() {
    var h = {}
      , mt = {}
      , c = {
        id: "ff0efbf5ca86a98bf0ec7422ce321f37",
        dm: ["suanhua.org"],
    ...
    ;
    mt.g.Ja = function(a) {
        return (a = mt.g.P(a, t)) && a.length ? String(a[0]) : ""
    }
    ;
    mt.g.tb = function(a) {
        return mt.g.P(a, v)
    ...
    mt.localStorage.set = function(a, b, d) {
        ...
        try {
            window.localStorage ? (b = g.getTime() + "|" + b,
            window.localStorage.setItem(a, b)) : mt.localStorage.K() && (mt.localStorage.i.expires = g.toUTCString(),
            mt.localStorage.i.load(document.location.hostname),
            mt.localStorage.i.setAttribute(a, b),
    ...
    (function() {
        var a = {
            ...
            B: function(a, d) {
                this.r[a] = this.r[a] || [];
                for (var g = this.r[a].length, f = 0; f < g; f++)
                    this.r[a][f](d)
            }
        };
        return h.w = a
    ...
    (function() {
        function a() {
            ...
            window.sessionStorage ? d.set("Hm_from_" + c.id, a) : b.set("Hm_from_" + c.id, a, 864E5)) : a = (window.sessionStorage ? d.get("Hm_from_" + c.id) : b.get("Hm_from_" + c.id)) || "";
            return a
        }
    ...
    (function() {
        var a = mt.g
          ...
          , n = {
            ka: function() {
                c.ctrk && (d.c(document, "mouseup", n.ra()),
                d.c(window, "unload", function() {
                    n.I()
                }),
            ...
            ra: function() {
                return function(a) {
                    a = n.Ca(a);
                    if ("" !== a) {
                        var d = (f.H + "//" + f.T + "?" + h.b.ga().replace(/ep=[^&]*/, "ep=" + encodeURIComponent(a))).length;
                        d + (f.s + "").length > f.X || (d + encodeURIComponent(l.join("!") + (l.length ? "!" : "")).length + (f.s + "").length > f.X && n.I(),
                        l.push(a),
                        (l.length >= f.ua || /\*a\*/.test(a)) && n.I())
                    }
                }
            },
            Ca: function(k) {
                ...
                var q;
                g.ca ? (q = Math.max(document.documentElement.scrollTop, document.body.scrollTop),
                m = Math.max(document.documentElement.scrollLeft, document.body.scrollLeft),
                m = k.clientX + m,
                q = k.clientY + q) : (m = k.pageX,
                q = k.pageY);
                k = n.Ga(k, d, m, q);
                ...
                e.push(k.qb);
                e.push(k.Ma);
                (d = "a" === (d.tagName || "").toLowerCase() ? d : a.Ba(d)) ? (e.push("a"),
                e.push(b.h(encodeURIComponent(d.href)))) : e.push("b");
                return e.join("*")
            },
            Ga: function(k, d, m, q) {
                k = a.Ja(d);
                var e = 0
                  ...
                  , f = 0
                  , l = 0;
                if (d && (e = d.offsetWidth || d.clientWidth,
                r = d.offsetHeight || d.clientHeight,
                l = a.Ha(d),
                f = l.left,
                l = l.top,
                b.d(d.getBBox, "Function") && (r = d.getBBox(),
                e = r.width,
                r = r.height),
                "html" === (d.tagName || "").toLowerCase()))
                    e = Math.max(e, d.clientWidth),
            ...
            c.rec && a.fa(function() {
                for (var p = 0, l = c.rp.length; p < l; p++) {
                    var n = c.rp[p][0]
                      , e = c.rp[p][1]
                      , k = a.Z("hm_t_" + n);
                    if (e && !(2 == e && !k || k && "" !== k.innerHTML))
                        k = "",
                        k = Math.round(Math.random() * b.s),
                        k = 4 == e ? f + "hl.js?" + ["siteId=" + c.id, "planId=" + n, "rnd=" + k].join("&") : f + "t.js?" + ["siteId=" + c.id, "planId=" + n, "from=" + g(), "referer=" + encodeURIComponent(document.referrer), "title=" + encodeURIComponent(document.title), "rnd=" + k].join("&"),
                        d(k)
                }
            })
        })
    ...
    (function() {
        ...
        function g(a) {
            if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window))
                k = "focus" == a.type || "focusin" == a.type ? t : v,
                b()
        }
        var f = mt.event, p = h.w, l = t, n = t, e = t, k = t, w = +new Date, m = w, q = 0, x = t, r = d("visibilityState"), y = d("hidden"), z;
        b();
        (function() {
            ...
            "object" == typeof document.onfocusin ? (f.c(document, "focusin", g),
            f.c(document, "focusout", g)) : (f.c(window, "focus", g),
            f.c(window, "blur", g))
        }
        )();
        h.M = {
          ...
          , e = {
            ...
            init: function() {
                ...
                l.c("stag-b", function() {
                    ...
                    h.b.a.ct = [decodeURIComponent(h.b.getData("Hm_ct_" + c.id) || ""), e.o.W, e.o.page].join("!")
                });
                l.c("stag-d", function() {
                    h.b.a.api = 0;
                    e.e = 0;
            ...
            za: function() {
                if (0 < e.A.length)
                    for (var a = 0, d = e.A.length; a < d; a++)
                        e.S(e.A[a]);
                e.A = u
            },
            S: function(a) {
                var b = a[0];
                if (e.hasOwnProperty(b) && d.d(e[b], "Function"))
                    e[b](a)
            },
            ...
            _trackEvent: function(a) {
                ...
                h.b.a.st = 4,
                h.b.a.et = 4,
                h.b.a.ep = d.h(a[1]) + "*" + d.h(a[2]) + (a[3] ? "*" + d.h(a[3]) : "") + (a[4] ? "*" + d.h(a[4]) : ""),
                h.b.j())
            },
            _setCustomVar: function(a) {
                if (!(4 > a.length)) {
                    ...
                    if (0 < b && 6 > b && 0 < m && 4 > m) {
                        e.J++;
                        for (var q = (h.b.a.cv || "*").split("!"), f = q.length; f < b - 1; f++)
                            q.push("*");
                        q[b - 1] = m + "*" + d.h(a[2]) + "*" + d.h(a[3]);
                        h.b.a.cv = q.join("!");
                        a = h.b.a.cv.replace(/[^1](\*[^!]*){2}/g, "*").replace(/((^|!)\*)+$/g, "");
                        "" !== a ? h.b.setData("Hm_cv_" + c.id, encodeURIComponent(a), c.age) : h.b.ab("Hm_cv_" + c.id)
                    }
                }
            },
            ...
            _setReferrerOverride: function(a) {
                1 < a.length && (h.b.a.su = a[1].charAt && "/" === a[1].charAt(0) ? p.protocol + "//" + window.location.host + a[1] : a[1],
                e.da = t)
            },
            ...
            _trackRTPageview: function(a) {
                ...
                d.d(a, "Object") && (b(a),
                a = g.stringify(a),
                512 >= encodeURIComponent(a).length && (e.e |= 64,
                h.b.a.rt = a))
            },
            _trackRTEvent: function(a) {
                ...
                if (d.d(a, "Object")) {
                    ...
                    if (900 >= m)
                        ...
                        for (var m = Math.ceil(m / 900), q = "block|" + Math.round(Math.random() * p.s).toString(16) + "|" + m + "|", l = [], r = 0; r < m; r++)
                            l.push(r),
                            l.push(a.substring(900 * r, 900 * r + 900)),
                            f.call(this, q + l.join("|")),
                            l = []
                }
            },
        ...
        a.prototype = {
            ...
            Ka: function() {
                if (!document.referrer)
                    return k.m - k.z > c.vdur ? 1 : 4;
                var a = v;
                this.F(document.referrer) && this.F(document.location.href) ? a = t : (a = b.aa(document.referrer),
                a = this.R(a || "", document.location.hostname));
            ...
            hb: function() {
                var a, b, d, e, f;
                k.z = this.getData("Hm_lpvt_" + c.id) || 0;
                ...
                if (0 === c.nv && this.F(document.location.href) && ("" === document.referrer || this.F(document.referrer)))
                    a = 0,
                    b = 4;
                this.a.nv = a;
                this.a.st = b;
            ...
            qa: function() {
                var a = document.location.hash.substring(1)
                  , d = RegExp(c.id)
                  , e = -1 < document.referrer.indexOf(k.oa)
                  , f = b.k(a, "jn")
                  , l = /^heatlink$|^select$|^pageclick$/.test(f);
                a && (d.test(a) && e && l) && (this.a.rnd = Math.round(Math.random() * k.s),
                a = document.createElement("script"),
                a.setAttribute("type", "text/javascript"),
                a.setAttribute("charset", "utf-8"),
                a.setAttribute("src", k.protocol + "//" + c.js + f + ".js?" + this.a.rnd),
            ...
            U: function(a) {
                ...
                (b = b.replace(a, "").replace(/,$/, "")) ? e.set("Hm_unsent_" + c.id, b) : e.remove("Hm_unsent_" + c.id))
            },
            gb: function() {
                var a = this
        ...
        if ("undefined" !== typeof h.b && (c.med || (!a.ca || 7 < a.Ta) && c.cvcc)) {
            var f, p, l, n, e = function(a) {
                ...
                if (d) {
                    ...
                    e.snv = k) : b.d(m, "String") && l.test(m) && (e.sn = "wrap",
                    e.snv = m);
                    e.id = p
                }
                h.b.a.et = 86;
            ...
            if (c.med)
                p = "/zoosnet",
                f = "swt",
                l = /swt|zixun|call|chat|zoos|business|talk|kefu|openkf|online|\/LR\/Chatpre\.aspx/i,
                n = {
                    click: function() {
                        for (var a = [], b = e(document.getElementsByTagName("a")), b = [].concat.apply(b, e(document.getElementsByTagName("area"))), b = [].concat.apply(b, e(document.getElementsByTagName("img"))), d, f, k = 0, g = b.length; k < g; k++)
                            d = b[k],
                            f = d.getAttribute("onclick"),
                            d = d.getAttribute("href"),
                            (l.test(f) || l.test(d)) && a.push(b[k]);
                        return a
                    }
                };
            else if (c.cvcc) {
                ...
                n = {
                    click: function() {
                        for (var a = [], b = e(document.getElementsByTagName("a")), b = [].concat.apply(b, e(document.getElementsByTagName("area"))), b = [].concat.apply(b, e(document.getElementsByTagName("img"))), d, f, k, g = 0, p = b.length; g < p; g++)
                            d = b[g],
                            l !== s ? (f = d.getAttribute("onclick"),
                            k = d.getAttribute("href"),
                            m ? (d = d.getAttribute("id"),
                            (l.test(f) || l.test(k) || m.test(d)) && a.push(b[g])) : (l.test(f) || l.test(k)) && a.push(b[g])) : m !== s && (d = d.getAttribute("id"),
                            m.test(d) && a.push(b[g]));
                        return a
                    }
                }
    ...
    (function() {
        ...
        if ("undefined" !== typeof h.b && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
            var f = {
                la: function() {
                    for (var b = c.cvcf.length, g, n = 0; n < b; n++)
                        (g = a.Z(decodeURIComponent(c.cvcf[n]))) && d.c(g, "click", f.xa())
                },
                xa: function() {
                    return function() {
                        h.b.a.et = 86;
